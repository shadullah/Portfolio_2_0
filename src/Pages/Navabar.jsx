...
const Navabar = () => {
  ...
  return (
    <div className="">
      <div className="f_div max-w-[1200px] flex mx-auto justify-around items-center bg-gradient-to-b from-blue-400 to-blue-600 my-8 px-12 py-6 rounded-3xl">
        <div className="">
          ...
          <div className="flex justify-between mt-4 text-white text-xs font-medium">
            ...
            <div className="text-center">
              <p className="mb-2">
                <i className="fa-solid fa-location-crosshairs text-white mr-2"></i>
              </p>
